...
Most agent actions are free. The paid actions are data lookups for contact discovery and email finding. Sending emails, creating contacts, updating statuses, escalating, and drafting replies are all **free**.

The exact cost per tool is shown on the agent configuration screen.
