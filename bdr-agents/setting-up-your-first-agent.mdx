...
| **Discover Contacts** | Find employees at a company | Per-use credit cost |
| **Search People** | Find specific people by role at a company | Per-use credit cost |
| **Lookup Profile** | Get full profile details for a person | Per-use credit cost |
| **Find Email** | Look up a person's email address | Per-use credit cost |
| **Domain Email Search** | Find senior contacts and emails at a domain | Per-use credit cost |
