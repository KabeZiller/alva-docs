...
Go to **Discovery → Search Agents** and click **Create New Search Agent**, then choose how you want to search:

- **Find companies** — search for companies by sector, service, and geography, then find contacts within them. This is the mode described on this page.
- **Find people** — search for people by job title, regardless of company. See [People Search](/discovery/people-search).

<Tip>
  Choose **Find companies** when you're targeting a market or industry, and **Find people** when the job title matters more than the company.
</Tip>

The rest of this page covers the **Find companies** mode.
