...
Each company discovered is billed from your credit balance at a tiered rate (£0.10–£0.20 per company depending on volume). Rejected companies are also billed — the cost covers the search and AI matching, not just the accepted results.
